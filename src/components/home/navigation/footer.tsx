...
const Footer = () => {
    return (
        <footer className="flex flex-col relative items-center justify-center border-t border-border pt-16 pb-20 md:pb-24 px-6 lg:px-8 w-full max-w-6xl mx-auto lg:pt-32">
